...
| Q011 | Does the learned 243-vector flow ranker add information beyond the exact joint HLR null? | slot_forecast|meta | **critical** | active audit `E0001` |
...
| Q003 | Can a slot/meta-lattice preserve future 5/5 coordinates at useful exposure versus matched exact controls? | candidate_funnel | high | downstream of `E0001` gate |
...
`E0001 — Exact Structural Null Championship and Gap-Space Residual Audit` is the current critical methodological gate for further HLR/VVD-driven Candidate Lattice expansion.
